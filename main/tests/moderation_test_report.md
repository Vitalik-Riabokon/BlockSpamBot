...
| ID | Case | Expected | Actual | Status | Notes |
|---|---|---|---|---|---|
| B01 | Educational ad with details | REVIEW_ALERT | ALLOW | FAIL | status=SAFE_TEXT; reasons=not_ad; score=0 |
...
| B04 | Whitelist trusted advertiser no alerts | ALLOW_WHITELIST_NO_ALERT | ALLOW_WHITELIST_NO_ALERT | PASS | status=AD_PENDING_AUTH; reasons=offer_keyword,cta_keyword,contact_or_link,pending_authorization; score=0 |
...
| C03 | Obfuscated casino domain | DELETE_BLOCK | ALLOW | FAIL | status=SAFE_TEXT; reasons=not_ad; score=0 |
| C04 | Pro-russian slogan in ad context | DELETE_BLOCK | REVIEW_ALERT | FAIL | status=AD_PENDING_AUTH; reasons=cta_keyword,contact_or_link,pending_authorization; score=0 |
...
| C06 | Whitelist user with hard block | DELETE_HARD_WHITELIST_ALERT | ALLOW | FAIL | status=SAFE_TEXT; reasons=not_ad; score=0 |

## D. Gray Ads

| ID | Case | Expected | Actual | Status | Notes |
|---|---|---|---|---|---|
| D01 | Remote job template | REVIEW_ALERT | REVIEW_ALERT | PASS | status=AD_PENDING_AUTH; reasons=cta_keyword,contact_or_link,scam_job_pattern,money_claim,pending_authorization; score=43 |
| D02 | Income claim | REVIEW_ALERT | REVIEW_ALERT | PASS | status=AD_PENDING_AUTH; reasons=offer_keyword,cta_keyword,contact_or_link,scam_job_pattern,money_claim,pending_authorization; score=43 |
...
| ID | Case | Expected | Actual | Status | Notes |
|---|---|---|---|---|---|
| E01 | Base suspicious message #1 | REVIEW_ALERT | REVIEW_ALERT | PASS | status=AD_PENDING_AUTH; reasons=offer_keyword,cta_keyword,contact_or_link,scam_job_pattern,pending_authorization; score=35 |
| E02 | Duplicate suspicious message #2 | DELETE_BLOCK | REVIEW_ALERT | FAIL | status=AD_SUSPECT; reasons=offer_keyword,cta_keyword,contact_or_link,scam_job_pattern,spam_pattern,score_suspect; score=60 |
...
| E05 | Flood msg #3 | DELETE_BLOCK | REVIEW_ALERT | FAIL | status=AD_SUSPECT; reasons=offer_keyword,cta_keyword,contact_or_link,scam_job_pattern,spam_pattern,score_suspect; score=60 |
...
| F04 | Part 4 (url only) | ALLOW | ALLOW | PASS | Split tactic partially bypasses single-message ad_intent |
...
| G05 | Legit bilingual info post | REVIEW_ALERT | ALLOW | FAIL | status=SAFE_TEXT; reasons=not_ad; score=0 |
...
| H05 | Tours + contacts + links | REVIEW_ALERT | ALLOW | FAIL | status=SAFE_TEXT; reasons=not_ad; score=0 |
...
| H09 | Parcel service recurring | REVIEW_ALERT | ALLOW | FAIL | status=SAFE_TEXT; reasons=not_ad; score=0 |
...
| I04 | Split part 4 | REVIEW_ALERT | REVIEW_ALERT | PASS | status=AD_PENDING_AUTH; reasons=cta_keyword,contact_or_link,scam_job_pattern,pending_authorization; score=35 |
| I05 | Split part 5 | ALLOW | ALLOW | PASS | Gap: last fragment may bypass without offer+cta combo |
| I06 | Split casino part 1 | ALLOW | ALLOW | PASS | status=SAFE_TEXT; reasons=not_ad; score=0 |
| I07 | Split casino part 2 | ALLOW | ALLOW | PASS | Gap: hard words may bypass if no ad_intent in message |
